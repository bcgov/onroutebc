...
IF @@ERROR <> 0 SET NOEXEC ON
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date and time that the transaction was approved in ORBC' , @level0type=N'SCHEMA',@level0name=N'permit', @level1type=N'TABLE',@level1name=N'ORBC_TRANSACTION', @level2type=N'COLUMN',@level2name=N'TRANSACTION_APPROVED_DATE'
...
SET @VersionDescription = 'Add TRANSACTION_APPROVED_DATE col to ORBC_TRANSACTION and ORBC_TRANSACTION_HIST'
