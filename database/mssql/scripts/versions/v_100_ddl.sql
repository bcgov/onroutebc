...
GO
IF NOT EXISTS (SELECT 1 FROM permit.ORBC_PERMIT_TYPE WHERE PERMIT_TYPE = N'STWSE')
BEGIN
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
IF NOT EXISTS (SELECT 1 FROM permit.ORBC_PERMIT_TYPE WHERE PERMIT_TYPE = N'STGVWI')
BEGIN
