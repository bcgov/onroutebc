...
DROP CONSTRAINT [FK_ORBC_SPECIAL_AUTH_NO_FEE_TYPE]

ALTER TABLE [permit].[ORBC_NO_FEE_TYPE]

DROP CONSTRAINT [PK_ORBC_NO_FEE_TYPE]

ALTER TABLE [permit].[ORBC_NO_FEE_TYPE]

ALTER COLUMN NO_FEE_TYPE VARCHAR(16) NOT NULL
