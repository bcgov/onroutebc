...
CREATE TABLE [permit].[ORBC_PERMIT_DATA](
	...
	[APPLICANT]  AS (CONCAT (json_value([PERMIT_DATA],'$.contactDetails.firstName'), ' ', json_value([PERMIT_DATA],'$.contactDetails.lastName'))),
	[UNIT_NUMBER]  AS (json_value([PERMIT_DATA],'$.vehicleDetails.unitNumber')),
	[PLATE]  AS (json_value([PERMIT_DATA],'$.vehicleDetails.plate')),
	[APP_CREATE_TIMESTAMP] [datetime2](7) DEFAULT (getutcdate()),
	[APP_CREATE_USERID] [nvarchar](30) DEFAULT (user_name()),
	[APP_CREATE_USER_GUID] [char](32) NULL,
	[APP_CREATE_USER_DIRECTORY] [nvarchar](30) DEFAULT (user_name()),
