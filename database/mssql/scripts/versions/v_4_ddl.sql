...
ALTER TABLE [permit].[ORBC_PERMIT] ADD  CONSTRAINT [DF_ORBC_PERMIT_METADATA_DB_CREATE_USERID]  DEFAULT (user_name()) FOR [DB_CREATE_USERID]
GO
ALTER TABLE [permit].[ORBC_PERMIT] ADD  CONSTRAINT [DF_ORBC_PERMIT_METADATA_DB_CREATE_TIMESTAMP]  DEFAULT (getdate()) FOR [DB_CREATE_TIMESTAMP]
GO
ALTER TABLE [permit].[ORBC_PERMIT] ADD  CONSTRAINT [DF_ORBC_PERMIT_METADATA_DB_LAST_UPDATE_USERID]  DEFAULT (user_name()) FOR [DB_LAST_UPDATE_USERID]
GO
ALTER TABLE [permit].[ORBC_PERMIT] ADD  CONSTRAINT [DF_ORBC_PERMIT_METADATA_DB_LAST_UPDATE_TIMESTAMP]  DEFAULT (getdate()) FOR [DB_LAST_UPDATE_TIMESTAMP]
GO
...
GO
ALTER TABLE [permit].[ORBC_PERMIT_DATA] ADD  CONSTRAINT [DF_ORBC_PERMIT_DB_CREATE_USERID]  DEFAULT (user_name()) FOR [DB_CREATE_USERID]
GO
ALTER TABLE [permit].[ORBC_PERMIT_DATA] ADD  CONSTRAINT [DF_ORBC_PERMIT_DB_CREATE_TIMESTAMP]  DEFAULT (getdate()) FOR [DB_CREATE_TIMESTAMP]
GO
ALTER TABLE [permit].[ORBC_PERMIT_DATA] ADD  CONSTRAINT [DF_ORBC_PERMIT_DB_LAST_UPDATE_USERID]  DEFAULT (user_name()) FOR [DB_LAST_UPDATE_USERID]
GO
ALTER TABLE [permit].[ORBC_PERMIT_DATA] ADD  CONSTRAINT [DF_ORBC_PERMIT_DB_LAST_UPDATE_TIMESTAMP]  DEFAULT (getdate()) FOR [DB_LAST_UPDATE_TIMESTAMP]
GO
...
GO
ALTER TABLE [permit].[ORBC_PERMIT]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PERMIT_METADATA_PARENT_PERMIT_METADATA] FOREIGN KEY([PREVIOUS_REV_ID])
REFERENCES [permit].[ORBC_PERMIT] ([ID])
GO
ALTER TABLE [permit].[ORBC_PERMIT] CHECK CONSTRAINT [FK_ORBC_PERMIT_METADATA_PARENT_PERMIT_METADATA]
GO
ALTER TABLE [permit].[ORBC_PERMIT]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PERMIT_METADATA_PERMIT_APPLICATION_ORIGIN] FOREIGN KEY([APPLICATION_ORIGIN_ID])
REFERENCES [permit].[ORBC_VT_PERMIT_APPLICATION_ORIGIN] ([ID])
GO
ALTER TABLE [permit].[ORBC_PERMIT] CHECK CONSTRAINT [FK_ORBC_PERMIT_METADATA_PERMIT_APPLICATION_ORIGIN]
GO
ALTER TABLE [permit].[ORBC_PERMIT]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PERMIT_METADATA_PERMIT_APPROVAL_SOURCE] FOREIGN KEY([PERMIT_APPROVAL_SOURCE_ID])
REFERENCES [permit].[ORBC_VT_PERMIT_APPROVAL_SOURCE] ([ID])
GO
ALTER TABLE [permit].[ORBC_PERMIT] CHECK CONSTRAINT [FK_ORBC_PERMIT_METADATA_PERMIT_APPROVAL_SOURCE]
GO
ALTER TABLE [permit].[ORBC_PERMIT]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PERMIT_METADATA_PERMIT_TYPE] FOREIGN KEY([PERMIT_TYPE_ID])
REFERENCES [permit].[ORBC_VT_PERMIT_TYPE] ([PERMIT_TYPE_ID])
GO
ALTER TABLE [permit].[ORBC_PERMIT] CHECK CONSTRAINT [FK_ORBC_PERMIT_METADATA_PERMIT_TYPE]
GO
ALTER TABLE [permit].[ORBC_PERMIT]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PERMIT_PERMIT_DATA] FOREIGN KEY([PERMIT_DATA_ID])
REFERENCES [permit].[ORBC_PERMIT_DATA] ([ID])
GO
ALTER TABLE [permit].[ORBC_PERMIT] CHECK CONSTRAINT [FK_ORBC_PERMIT_PERMIT_DATA]
GO
ALTER TABLE [permit].[ORBC_PERMIT_COMMENTS]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PERMIT_COMMENTS_PERMIT_METADATA] FOREIGN KEY([PERMIT_ID])
REFERENCES [permit].[ORBC_PERMIT] ([ID])
GO
ALTER TABLE [permit].[ORBC_PERMIT_COMMENTS] CHECK CONSTRAINT [FK_ORBC_PERMIT_COMMENTS_PERMIT_METADATA]
GO
ALTER TABLE [permit].[ORBC_PERMIT_STATE]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PERMIT_STATE_PERMIT_METADATA] FOREIGN KEY([PERMIT_ID])
REFERENCES [permit].[ORBC_PERMIT] ([ID])
GO
...
INSERT [permit].[ORBC_VT_PERMIT_APPLICATION_ORIGIN] ([ID], [DESCRIPTION], [CODE], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (N'ONLINE', N'Created Online', 2, NULL, N'dbo', CAST(N'2023-04-13T19:31:23.6700000' AS DateTime2), N'dbo', CAST(N'2023-04-13T19:31:23.6700000' AS DateTime2))
GO
INSERT [permit].[ORBC_VT_PERMIT_APPLICATION_ORIGIN] ([ID], [DESCRIPTION], [CODE], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (N'PPC', N'Created by PPC', 1, NULL, N'dbo', CAST(N'2023-04-13T19:31:15.4166667' AS DateTime2), N'dbo', CAST(N'2023-04-13T19:31:15.4166667' AS DateTime2))
GO
INSERT [permit].[ORBC_VT_PERMIT_APPROVAL_SOURCE] ([ID], [DESCRIPTION], [CODE], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (N'AUTO', N'Auto Approved Online by Carrier', 2, NULL, N'dbo', CAST(N'2023-04-13T19:36:24.9466667' AS DateTime2), N'dbo', CAST(N'2023-04-13T19:36:24.9466667' AS DateTime2))
GO
INSERT [permit].[ORBC_VT_PERMIT_APPROVAL_SOURCE] ([ID], [DESCRIPTION], [CODE], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (N'PPC', N'Approved by PPC', 1, NULL, N'dbo', CAST(N'2023-04-13T19:36:10.2233333' AS DateTime2), N'dbo', CAST(N'2023-04-13T19:36:10.2233333' AS DateTime2))
GO
INSERT [permit].[ORBC_VT_PERMIT_APPROVAL_SOURCE] ([ID], [DESCRIPTION], [CODE], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (N'TPS', N'Imported from TPS', 0, NULL, N'dbo', CAST(N'2023-04-13T19:36:02.7033333' AS DateTime2), N'dbo', CAST(N'2023-04-13T19:36:02.7033333' AS DateTime2))
GO
