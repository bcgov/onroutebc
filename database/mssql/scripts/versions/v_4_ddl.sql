...
INSERT [permit].[ORBC_PERMIT_ISSUED_BY_TYPE] ([PERMIT_ISSUED_BY_TYPE], [DESCRIPTION], [CONCURRENCY_CONTROL_NUMBER], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (N'SELF-ISSUED', N'Issued by Self', NULL, N'dbo', GETUTCDATE(), N'dbo', GETUTCDATE())
...
WHERE permit.PERMIT_ISSUED_BY_TYPE = 'PPC'
	AND permit.PERMIT_STATUS_TYPE = 'ISSUED'
