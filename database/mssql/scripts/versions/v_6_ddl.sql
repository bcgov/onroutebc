...
ALTER TABLE [dbo].[ORBC_DOCUMENT]  WITH CHECK ADD  CONSTRAINT [ORBC_DOCUMENT_COMPANY_ID_FK] FOREIGN KEY([COMPANY_ID])
REFERENCES [dbo].[ORBC_COMPANY] ([COMPANY_ID])
GO
ALTER TABLE [dbo].[ORBC_DOCUMENT] CHECK CONSTRAINT [ORBC_DOCUMENT_COMPANY_ID_FK]
GO
