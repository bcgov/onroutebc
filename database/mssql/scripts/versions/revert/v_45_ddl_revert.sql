...
BEGIN TRY
  BEGIN TRANSACTION
    ...
    ALTER TABLE [permit].[ORBC_PERMIT_LOA]
	  DROP CONSTRAINT [FK_ORBC_PERMIT_LOA_LOA_ID]
    ALTER TABLE [permit].[ORBC_PERMIT_LOA]
	  DROP CONSTRAINT [FK_ORBC_PERMIT_LOA_PERMIT_ID]
    ALTER TABLE [permit].[ORBC_PERMIT_LOA]
	  DROP CONSTRAINT [CK_ORBC_PERMIT_LOA_UNQ]
