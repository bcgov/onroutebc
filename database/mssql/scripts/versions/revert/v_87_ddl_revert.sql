...
SET @VersionDescription = 'Reverting updates to policy config to support vehicle font display code'

INSERT [dbo].[ORBC_SYS_VERSION] ([VERSION_ID], [DESCRIPTION], [RELEASE_DATE]) VALUES (86, @VersionDescription, getutcdate())
GO
