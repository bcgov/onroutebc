...
BEGIN TRY
  BEGIN TRANSACTION
      ...
      WITH CHECK ADD CONSTRAINT [FK_ORBC_LOA_VEHICLES_LOA_ID] FOREIGN KEY ([LOA_ID]) REFERENCES [permit].[ORBC_LOA_DETAILS]([LOA_ID])  ON DELETE CASCADE
      ALTER TABLE [permit].[ORBC_LOA_VEHICLES] CHECK CONSTRAINT [FK_ORBC_LOA_VEHICLES_LOA_ID]
      ALTER TABLE [permit].[ORBC_LOA_PERMIT_TYPE_DETAILS]
      WITH CHECK ADD CONSTRAINT [FK_ORBC_LOA_PERMIT_TYPE_LOA_ID] FOREIGN KEY ([LOA_ID]) REFERENCES [permit].[ORBC_LOA_DETAILS]([LOA_ID])  ON DELETE CASCADE
