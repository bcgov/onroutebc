...
UPDATE dbo.ORBC_TRAILER_TYPE set [TYPE]='Fixed Equipment Semi-Trailer (16 and 24 Wheeler) Peace River',[DESCRIPTION]='Fixed Equipment Semi-Trailer (16 and 24 Wheeler) Peace River',DB_LAST_UPDATE_TIMESTAMP = GETUTCDATE(),DB_LAST_UPDATE_USERID = CURRENT_USER where TRAILER_TYPE='FEWHLPR';

UPDATE [dbo].[ORBC_POWER_UNIT_TYPE] set IS_ACTIVE='1',DB_LAST_UPDATE_TIMESTAMP = GETUTCDATE(),DB_LAST_UPDATE_USERID = CURRENT_USER WHERE [POWER_UNIT_TYPE] IN ('CRAFTAT','CRAFTMB','FARMVEH');

UPDATE [dbo].[ORBC_TRAILER_TYPE] set IS_ACTIVE='1',DB_LAST_UPDATE_TIMESTAMP = GETUTCDATE(),DB_LAST_UPDATE_USERID = CURRENT_USER WHERE [TRAILER_TYPE] IN ('FECVYPT');
