...
GO
ALTER TABLE [permit].[ORBC_TRANSACTION] DROP COLUMN [TRANSACTION_APPROVED_DATE]
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [permit].[ORBC_TRANSACTION_HIST] DROP COLUMN [TRANSACTION_APPROVED_DATE]

IF @@ERROR <> 0 SET NOEXEC ON
GO
DECLARE @VersionDescription VARCHAR(255)
SET @VersionDescription = 'Reverting addition of TRANSACTION_APPROVED_DATE col to ORBC_TRANSACTION and ORBC_TRANSACTION_HIST.'
