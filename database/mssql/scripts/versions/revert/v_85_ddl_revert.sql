...
GO
ALTER TABLE [permit].[ORBC_TRANSACTION] DROP CONSTRAINT [ORBC_TRANSACTION_CREDIT_ACCOUNT_ID_FK]

IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [permit].[ORBC_TRANSACTION] DROP COLUMN [CREDIT_ACCOUNT_ID]
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [permit].[ORBC_TRANSACTION_HIST] DROP COLUMN [CREDIT_ACCOUNT_ID]

IF @@ERROR <> 0 SET NOEXEC ON
GO
DECLARE @VersionDescription VARCHAR(255)
SET @VersionDescription = 'Reverting addition of CREDIT_ACCOUNT_ID col to ORBC_TRANSACTION and ORBC_TRANSACTION_HIST.'

INSERT [dbo].[ORBC_SYS_VERSION] ([VERSION_ID], [DESCRIPTION], [RELEASE_DATE]) VALUES (84, @VersionDescription, getutcdate())
