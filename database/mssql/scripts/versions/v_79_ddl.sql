...
CREATE TABLE [dbo].[ORBC_LOGIN_HIST](
  ...
  , [LOGIN_ID] int NOT NULL, [USER_DIRECTORY] varchar(10) NOT NULL, [USERNAME] nvarchar(50) NOT NULL, [USER_GUID] char(32) NOT NULL, [COMPANY_GUID] char(32) NULL, [COMPANY_LEGAL_NAME] nvarchar(500) NULL , [EMAIL] nvarchar(100) NULL, [LOGIN_DATE_TIME] datetime2 NOT NULL, [APP_CREATE_TIMESTAMP] datetime2 NULL, [APP_CREATE_USERID] nvarchar(30) NULL, [APP_CREATE_USER_GUID] char(32) NULL, [APP_CREATE_USER_DIRECTORY] nvarchar(30) NULL, [APP_LAST_UPDATE_TIMESTAMP] datetime2 NULL, [APP_LAST_UPDATE_USERID] nvarchar(30) NULL, [APP_LAST_UPDATE_USER_GUID] char(32) NULL, [APP_LAST_UPDATE_USER_DIRECTORY] nvarchar(30) NULL, [CONCURRENCY_CONTROL_NUMBER] int NULL, [DB_CREATE_USERID] varchar(63) NOT NULL, [DB_CREATE_TIMESTAMP] datetime2 NOT NULL, [DB_LAST_UPDATE_USERID] varchar(63) NOT NULL, [DB_LAST_UPDATE_TIMESTAMP] datetime2 NOT NULL
  )
