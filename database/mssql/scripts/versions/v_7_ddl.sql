...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [permit].[ORBC_PAYMENT_PERMIT](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[PAYMENT_ID] [bigint] NOT NULL,
...
ALTER TABLE [permit].[ORBC_PAYMENT_PERMIT]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PAYMENT_PERMIT_PAYMENT_ID] FOREIGN KEY([PAYMENT_ID])
REFERENCES [permit].[ORBC_PAYMENT] ([ID])
GO

ALTER TABLE [permit].[ORBC_PAYMENT_PERMIT]  WITH CHECK ADD  CONSTRAINT [FK_ORBC_PAYMENT_PERMIT_PERMIT_ID] FOREIGN KEY([PERMIT_ID])
