...
INSERT [permit].[ORBC_VT_PAYMENT_METHOD] ([PAYMENT_METHOD_ID], [NAME], [DESCRIPTION], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (1, N'Web', N'Web', N'dbo', GETUTCDATE(), N'dbo', GETUTCDATE())
INSERT [permit].[ORBC_VT_PAYMENT_METHOD] ([PAYMENT_METHOD_ID], [NAME], [DESCRIPTION], [DB_CREATE_USERID], [DB_CREATE_TIMESTAMP], [DB_LAST_UPDATE_USERID], [DB_LAST_UPDATE_TIMESTAMP]) VALUES (2, N'Icepay', N'Ice Pay', N'dbo', GETUTCDATE(), N'dbo', GETUTCDATE())
GO
