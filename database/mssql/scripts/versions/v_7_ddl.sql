...
CREATE TABLE [permit].[ORBC_VT_PAYMENT_METHOD](
 ...
 CONSTRAINT [ORBC_VT_PAYMENT_MOTHOD_PK] PRIMARY KEY CLUSTERED 
(
...
ALTER TABLE [permit].[ORBC_TRANSACTION] ADD  CONSTRAINT [ORBC_TRANSACTION_DB_CREATE_USERID_UK]  DEFAULT (user_name()) FOR [DB_CREATE_USERID]
GO
ALTER TABLE [permit].[ORBC_TRANSACTION] ADD  CONSTRAINT [ORBC_TRANSACTION_DB_CREATE_TIMESTAMP_UK]  DEFAULT (getutcdate()) FOR [DB_CREATE_TIMESTAMP]
GO
ALTER TABLE [permit].[ORBC_TRANSACTION] ADD  CONSTRAINT [ORBC_TRANSACTION_DB_LAST_UPDATE_USERID_UK]  DEFAULT (user_name()) FOR [DB_LAST_UPDATE_USERID]
GO
ALTER TABLE [permit].[ORBC_TRANSACTION] ADD  CONSTRAINT [ORBC_TRANSACTION_DB_LAST_UPDATE_TIMESTAMP_UK]  DEFAULT (getutcdate()) FOR [DB_LAST_UPDATE_TIMESTAMP]
GO
...
ALTER TABLE [permit].[ORBC_PERMIT_TRANSACTION] ADD  CONSTRAINT [ORBC_PERMIT_TRANSACTION_DB_CREATE_USERID_UK]  DEFAULT (user_name()) FOR [DB_CREATE_USERID]
GO
ALTER TABLE [permit].[ORBC_PERMIT_TRANSACTION] ADD  CONSTRAINT [ORBC_PERMIT_TRANSACTION_DB_CREATE_TIMESTAMP_UK]  DEFAULT (getutcdate()) FOR [DB_CREATE_TIMESTAMP]
GO
ALTER TABLE [permit].[ORBC_PERMIT_TRANSACTION] ADD  CONSTRAINT [ORBC_PERMIT_TRANSACTION_DB_LAST_UPDATE_USERID_UK]  DEFAULT (user_name()) FOR [DB_LAST_UPDATE_USERID]
GO
ALTER TABLE [permit].[ORBC_PERMIT_TRANSACTION] ADD  CONSTRAINT [ORBC_PERMIT_TRANSACTION_DB_LAST_UPDATE_TIMESTAMP_UK]  DEFAULT (getutcdate()) FOR [DB_LAST_UPDATE_TIMESTAMP]
GO
ALTER TABLE [permit].[ORBC_RECEIPT] ADD  CONSTRAINT [ORBC_RECEIPT_DB_CREATE_USERID_UK]  DEFAULT (user_name()) FOR [DB_CREATE_USERID]
GO
ALTER TABLE [permit].[ORBC_RECEIPT] ADD  CONSTRAINT [ORBC_RECEIPT_DB_CREATE_TIMESTAMP_UK]  DEFAULT (getutcdate()) FOR [DB_CREATE_TIMESTAMP]
GO
ALTER TABLE [permit].[ORBC_RECEIPT] ADD  CONSTRAINT [ORBC_RECEIPT_DB_LAST_UPDATE_USERID_UK]  DEFAULT (user_name()) FOR [DB_LAST_UPDATE_USERID]
GO
ALTER TABLE [permit].[ORBC_RECEIPT] ADD  CONSTRAINT [ORBC_RECEIPT_DB_LAST_UPDATE_TIMESTAMP_UK]  DEFAULT (getutcdate()) FOR [DB_LAST_UPDATE_TIMESTAMP]
GO
