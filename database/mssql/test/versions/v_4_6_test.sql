...
INSERT INTO $(DB_NAME).permit.ORBC_PERMIT(ID, COMPANY_ID, PERMIT_TYPE_ID, APPLICATION_ORIGIN_ID, PERMIT_APPROVAL_SOURCE_ID, APPLICATION_NUMBER, PERMIT_NUMBER) VALUES(35, 1, 'TROS', 'ONLINE', 'PPC', 'A2-00000035-321', 'P2-00000035-123')
