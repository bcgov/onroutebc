...
# Test 27.1 - verify that the transaction table exists
...
if [[ $TEST_27_1_RESULT -eq 1 ]]; then
    echo "Test 27.1 passed: All ORBC transaction tables exist"
else
    echo "******** Test 27.1 failed: Missing one or more ORBC transaction tables"
fi
