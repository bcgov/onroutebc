...
INSERT INTO $(DB_NAME).permit.ORBC_PERMIT(ID, COMPANY_ID, PERMIT_TYPE_ID, APPLICATION_ORIGIN_ID) VALUES(35, 1, 'TROS', 'ONLINE')
...
SET IDENTITY_INSERT $(DB_NAME).[permit].[ORBC_PERMIT] ON 
INSERT INTO $(DB_NAME).permit.ORBC_PERMIT(ID, COMPANY_ID, PERMIT_TYPE_ID, APPLICATION_ORIGIN_ID, REVISION, PREVIOUS_REV_ID) VALUES(36, 1, 'TROS', 'ONLINE', 1, 35)
SET IDENTITY_INSERT $(DB_NAME).[permit].[ORBC_PERMIT] OFF

SELECT APPLICATION_NUMBER FROM $(DB_NAME).permit.ORBC_PERMIT WHERE ID = 36
