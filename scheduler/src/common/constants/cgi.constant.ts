export class CgiConstants {
  static readonly BATCH_TYPE = 'GA'; // batch type
  static readonly PREFIX = 'MT'; // feeder prefix, to be discussed
  static readonly TRANSACTION_TYPE_BH = 'BH'; // batch header
  static readonly MESSAGE_VERSION = '4010'; // message version
  static readonly FUTURE = 'abcd'; // future
  static readonly CLIENT = '034'; // client
  static readonly RESPONSIBILITY = '55331'; // responsibility
