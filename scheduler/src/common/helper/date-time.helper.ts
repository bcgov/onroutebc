...
export const getToDateForGarms = () => {
  ...
  console.log('currentTimeInTargetTimezone', currentTimeInTargetTimezone);
  console.log('yesterdayAt9PmInTargetTimezone', yesterdayAt9PmInTargetTimezone);
  console.log('todayAt9PmInTargetTimezone', todayAt9PmInTargetTimezone);
  console.log(
    'lastRunTimestampInTargetTimezone',
    lastRunTimestampInTargetTimezone,
  );
  console.log(
    'lastRunTimestampInTargetTimezone.utc().toDate()',
    lastRunTimestampInTargetTimezone.utc().toDate(),
  );
