...
export enum TemplateName {
  ...
  PERMIT_STWSE = 'PERMIT_STWSE',
  PERMIT_STWSE_VOID = 'PERMIT_STWSE_VOID',
  PERMIT_STWSE_REVOKED = 'PERMIT_STWSE_REVOKED',
  PERMIT_STGVWI = 'PERMIT_STGVWI',
  PERMIT_STGVWI_VOID = 'PERMIT_STGVWI_VOID',
  PERMIT_STGVWI_REVOKED = 'PERMIT_STGVWI_REVOKED',
}
