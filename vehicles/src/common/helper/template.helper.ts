...
export const getPermitTemplateName = (
  ...
  const templateMapping: PermitTemplateMapping = {
    [ApplicationStatus.ISSUED]: {
      ...
      [PermitType.SINGLE_TRIP_GVWI]: TemplateName.PERMIT_STGVWI,
    ...
    [ApplicationStatus.VOIDED]: {
      ...
      [PermitType.SINGLE_TRIP_GVWI]: TemplateName.PERMIT_STGVWI_VOID,
    ...
    [ApplicationStatus.REVOKED]: {
      ...
      [PermitType.SINGLE_TRIP_GVWI]: TemplateName.PERMIT_STGVWI_REVOKED,
