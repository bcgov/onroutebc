    ...
    <footer className="footer">
      <div className="container">
        <ul>
          ...
          <li>
            <a href="https://www2.gov.bc.ca/gov/content/home/accessible-government" target="_blank" rel="noopener noreferrer">
              Accessibility
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://onroutebc.gov.bc.ca" target="_blank" rel="noopener noreferrer">
              Contact Us
            </a>
          </li>
        </ul>
