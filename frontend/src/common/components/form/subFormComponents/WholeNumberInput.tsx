...
export const WholeNumberInput = <T extends ORBC_FormTypes>(
  ...
  const className = `custom-number-input ${props.disabled ? "custom-number-input--disabled" : ""} ${props.invalid ? "custom-phone-input--invalid" : ""}`;
