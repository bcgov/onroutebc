...
const navigateBCeID = (
  ...
  const isAssociatedSuspended = associatedCompanies?.find((element) => element?.isSuspended);
  const isPendingSuspended = pendingCompanies?.find((element) => element?.isSuspended);
