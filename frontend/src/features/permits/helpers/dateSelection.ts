...
import {
  MAX_STWSE_CV_DURATION,
  MAX_STWSE_STAFF_DURATION,
  MIN_STWSE_DURATION,
  STWSE_CV_DURATION_OPTIONS,
  STWSE_DURATION_INTERVAL_DAYS,
  STWSE_STAFF_DURATION_OPTIONS,
} from "../constants/stwse";
import { EPTOP_CV_DURATION_OPTIONS, EPTOP_DURATION_INTERVAL_DAYS, EPTOP_STAFF_DURATION_OPTIONS, MAX_EPTOP_CV_DURATION, MAX_EPTOP_STAFF_DURATION, MIN_EPTOP_DURATION } from "../constants/eptop";
...
export const getDurationIntervalDays = (permitType: PermitType) => {
  switch (permitType) {
    ...
    case PERMIT_TYPES.STWSE:
      return STWSE_DURATION_INTERVAL_DAYS;
    case PERMIT_TYPES.TROW:
