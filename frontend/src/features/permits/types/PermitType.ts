...
export const getPermitTypeName = (permitType?: Nullable<string>) => {
  switch (permitType) {
    ...
    case PERMIT_TYPES.NRSCV:
      return "Non-Resident Single Trip Licensing";
    case PERMIT_TYPES.NRQCV:
      return "Non-Resident Quarterly Licensing";
...
export const getPermitTypeShortName = (permitType?: Nullable<string>) => {
  switch (permitType) {
    ...
    case PERMIT_TYPES.STWSE:
      return "Overweight Oversize Empty - Length over 27.5 m";
    case PERMIT_TYPES.RIG:
      return "Rig Move";
    case PERMIT_TYPES.STGVWI:
      return "Single Trip GVW Increase";
...
export const isQuarterlyPermit = (permitType?: Nullable<PermitType>) => {
  ...
  return ([PERMIT_TYPES.QRFR, PERMIT_TYPES.NRQCV] as PermitType[]).includes(
    permitType,
  );
};
