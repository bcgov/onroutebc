...
export const STWSE_CONDITIONS: PermitCondition[] = [
  {
...
export const STWSE_CV_DURATION_OPTIONS = [
  { value: MIN_STWSE_DURATION, label: "1 Day" },
  { value: 2, label: "2 Days" },
  { value: 3, label: "3 Days" },
  { value: 4, label: "4 Days" },
  { value: 5, label: "5 Days" },
  { value: 6, label: "6 Days" },
  { value: MAX_STWSE_CV_DURATION, label: "7 Days" },
];

export const STWSE_STAFF_DURATION_OPTIONS = [
  { value: MIN_STWSE_DURATION, label: "1 Day" },
  { value: 2, label: "2 Days" },
  { value: 3, label: "3 Days" },
  { value: 4, label: "4 Days" },
  ...
  { value: MAX_STWSE_STAFF_DURATION, label: "30 Days" },
];

export const STWSE_DURATION_INTERVAL_DAYS = 1;
