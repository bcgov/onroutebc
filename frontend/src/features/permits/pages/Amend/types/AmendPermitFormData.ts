    ...
    ...getDefaultValues(
      {
        ...
        permitData: {
          ...
          clientNumber: getDefaultRequiredVal(
            "",
            permit.permitData?.clientNumber,
          ),
        },
      },
      permit.companyId,
...
export const getDefaultFromNullableFormData = (
  ...
  return {
    ...
    previousRevision: getDefaultRequiredVal(
      "",
      permitFormData.previousRevision,
    ),
    ...
    permitData: {
      ...
      companyName: getDefaultRequiredVal(
        "",
        permitFormData.permitData?.companyName,
      ),
      clientNumber: getDefaultRequiredVal(
        "",
        permitFormData.permitData?.clientNumber,
      ),
    },
  };
};
...
export const arePermitsEqual = (
  ...
  return (
    permit1.permitId === permit2.permitId &&
    ...
    areApplicationDataEqual(
      {
        ...
        clientNumber: getDefaultRequiredVal(
          "",
          permit1.permitData.clientNumber,
        ),
      },
      {
        ...permit2.permitData,
        ...
        clientNumber: getDefaultRequiredVal(
          "",
          permit2.permitData.clientNumber,
        ),
      },
    )
  );
