...
const clfLink = (clf: ConditionalLicensingFeeType) => {
  switch (clf) {
    case CONDITIONAL_LICENSING_FEE_TYPES.CONDITIONAL_LICENSING_FEE_RATE:
      return {
        link: CONDITIONAL_LICENSING_FEE_LINKS.CONDITIONAL_LICENSING_FEE_RATE
          .URL,
        text: CONDITIONAL_LICENSING_FEE_LINKS.CONDITIONAL_LICENSING_FEE_RATE
          .LINK_TEXT,
      };
    case CONDITIONAL_LICENSING_FEE_TYPES.INDUSTRIAL_X_PLATE_TYPE_FEE_RATE:
      return {
        link: CONDITIONAL_LICENSING_FEE_LINKS.INDUSTRIAL_X_PLATE_TYPE_FEE_RATE
          .URL,
        text: CONDITIONAL_LICENSING_FEE_LINKS.INDUSTRIAL_X_PLATE_TYPE_FEE_RATE
          .LINK_TEXT,
      };
    case CONDITIONAL_LICENSING_FEE_TYPES.FARM_VEHICLE_FEE_RATE:
      return {
    ...
    case CONDITIONAL_LICENSING_FEE_TYPES.COMMERCIAL_PASSENGER_VEHICLE_FEE_RATE:
      return {
        link: CONDITIONAL_LICENSING_FEE_LINKS
          .COMMERCIAL_PASSENGER_VEHICLE_FEE_RATE.URL,
        text: CONDITIONAL_LICENSING_FEE_LINKS
          .COMMERCIAL_PASSENGER_VEHICLE_FEE_RATE.LINK_TEXT,
      };
    case CONDITIONAL_LICENSING_FEE_TYPES.NONE:
    default:
      return null;
...
export const ConditionalLicensingFeeLabel = ({
  ...
  return (
    <>
      <span className={classes?.label}>{clfLabelText(clf)}</span>
