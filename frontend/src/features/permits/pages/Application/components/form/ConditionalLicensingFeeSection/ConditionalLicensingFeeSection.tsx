...
export const ConditionalLicensingFeeSection = ({
  ...
  onChange: (
    updatedConditionalLicensingFeeType: RequiredOrNull<ConditionalLicensingFeeType>,
  ) => void;
}) => {
  const showSection = (
    ...
    <div className="conditional-licensing-fee-section">
      ...
      <Box className="conditional-licensing-fee-section__body">
        <RadioGroup
          ...
          onChange={(e) =>
            onChange(e.target.value as ConditionalLicensingFeeType)
          }
        >
          <ConditionalLicensingFeeOption
            ...
            disabled={
              !availableCLFs.includes(CONDITIONAL_LICENSING_FEE_TYPES.NONE)
            }
          ...
          <ConditionalLicensingFeeOption
            ...
            disabled={
              !availableCLFs.includes(
                CONDITIONAL_LICENSING_FEE_TYPES.FARM_TRACTOR_FEE_RATE,
              )
            }
