...
export class ProfileRegistrationEmailDto extends EmailRequestDto implements ProfileRegistrationEmailData {
  @ApiProperty({
  ...
  @ApiProperty({
    description: "The company primary contact's alternate phone number (if any).",
